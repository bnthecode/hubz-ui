import { setDrive, setSelectedDriveItem, setDriveLoading, setDriveFolders } from '../redux/actions/driveActions';
import { createDrive, createFolder, createFile, getDrive } from '../services/http/drive-http';
...
export const createDriveWorkflow = () => async dispatch => {
...
export const createFileWorkflow = (driveId, folderId, file) => async dispatch => {
